...
namespace Photon.Pun
{
    ...
    public class MonoBehaviourPunCallbacks : MonoBehaviourPun, IConnectionCallbacks , IMatchmakingCallbacks , IInRoomCallbacks,  IWebRpcCallback, IErrorInfoCallback
    {
